...
import commissionRuleRoutes from "./admin/commission-rule.routes.js";
...
import adminDisputeRoutes from "./admin/dispute.routes.js";
...
import subscriptionVisibilityRoutes from "./admin/subscription-visibility.routes.js";
import subscriptionPlanRoutes from "./admin/subscription-plan.routes.js";
...
app.use("/api/admin/commission-rules", commissionRuleRoutes);
...
app.use("/api/admin/subscriptions/visibility", subscriptionVisibilityRoutes);
app.use("/api/admin/subscriptions/plans", subscriptionPlanRoutes);

...
export default function TransporterBookings() {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.title}>Express Assignments</Text>
      <Text style={styles.subtitle}>
        Manage your assigned Express shipments from dispatch through delivery.
      </Text>
      ...
      {bookings.length === 0 ? (
        <View style={styles.empty}>
          <Text style={styles.emptyTitle}>No Express assignments yet</Text>
          <Text style={styles.emptyText}>
            Express shipments assigned to you will appear here.
          </Text>
        </View>
      ) : (
